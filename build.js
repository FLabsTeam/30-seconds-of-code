...
const REPO_NAME = "30-seconds-of-code"
const REPO_OWNER = process.env.GITHUB_REPOSITORY_OWNER || "nyana.ai"
const SHA = process.env.GITHUB_SHA || 123

let docId = "9686175d-6bdd-4c9c-b709-6fcde0d4852e"
...
function getAbstractionHtml(_artefact) {
    ...
    return `<div class="abstraction">${_artefact.data}</div>`
}
